...
def load_datasets():
    ...
    for i in range(years.size):
        ...
        path_pred = f'./data/csv/waterlevel_timeseries/Vlissingen/Vlissingen_{years[i]}.csv'
        path_meas = f'./data/bin/waterlevel_timeseries/Vlissingen/Vlissingen_{years[i]}.parquet'
        ...
        df_meas = pd.read_parquet(path_meas)
...
print(rho_est, sigma_est_rescaled)
