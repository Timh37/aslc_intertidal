...
def figure_1a(save = True):
    ...
    plt.ylim(-1.2, 1.2)
    if save:
        plt.savefig('./figures/figure_1a.png', dpi = 300)
    plt.show()

def figure_1b(save = True):
    ...
    if save:
        plt.savefig('./figures/figure_1b.png', dpi = 300)
    plt.show()

def figure_1c(save = True):
    ...
    if save:
        plt.savefig('./figures/figure_1c.png', dpi = 300)
    plt.show()

def figure_1d(save = True):
...
def figure_1f(save = True):
    ...
    plt.xlim(-2.4/2, 2.4/2)
    if save:
        plt.savefig('./figures/figure_1f.png', dpi = 300)
    plt.show()

figure_1a(save = False)
figure_1b(save = False)
figure_1c(save = False)
figure_1d(save = False)
figure_1e(save = False)
figure_1f(save = False)
