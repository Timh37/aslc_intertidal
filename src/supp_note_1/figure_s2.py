...
def run_batch_sim(path_bin, path_png):
...
run_test()
run_batch_sim(path_bin = './bin/supp_note_2/figure_s4.npy', path_png = './figures/supp_note_2/figure_s4.png')
