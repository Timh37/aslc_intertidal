...
def figure_s3(path_bin, path_png = None, sigma_w = 0.0, n_years = 10):
    ...
    def plot_figure(amplitude_annual_cycle, supratidal_boundary, upper_intertidal_boundary, lower_intertidal_boundary, subtidal_boundary):
        ...
        plt.title(f'$σ_w$ = {np.round(sigma_w,1)}')
    ...
    if os.path.exists(path_bin) == False:
        amplitude_annual_cycle, supratidal_boundary, upper_intertidal_boundary, lower_intertidal_boundary, subtidal_boundary = run_simulation(sigma_w = sigma_w, n_years = n_years)
...
def figure_s4(path_bin, path_png = None):
    ...
    def run_batch_sim(path_bin):
        ...
        for iy in range(n_trials):
            _, supratidal_boundary[:,iy], upper_intertidal_boundary[:,iy], lower_intertidal_boundary[:,iy], subtidal_boundary[:,iy] = run_simulation(amplitude_annual_cycle[:,iy], amplitude_S2[0,iy], sigma_w[0,iy], n_years)
    ...
    # Load simulation results
    amplitude_annual_cycle, _, sigma_w, _, upper_intertidal_boundary, _, _ = np.load(path_bin)    
...
# Figure S3 panels
figure_s3(path_bin = './bin/supp_note_2/figure_s3/figure_s3-0.0.npy', path_png = './figures/supp_note_2/figure_s3/figure_s3-0.0.png', sigma_w = 0.0, n_years = 1)
figure_s3(path_bin = './bin/supp_note_2/figure_s3/figure_s3-0.1.npy', path_png = './figures/supp_note_2/figure_s3/figure_s3-0.1.png', sigma_w = 0.1, n_years = 10)
figure_s3(path_bin = './bin/supp_note_2/figure_s3/figure_s3-0.2.npy', path_png = './figures/supp_note_2/figure_s3/figure_s3-0.2.png', sigma_w = 0.2, n_years = 20)

# figure_s4(path_bin = './bin/supp_note_2/figure_s4/figure_s4-new.npy', path_png = './figures/supp_note_2/figure_s4/figure_s4-new.png')
